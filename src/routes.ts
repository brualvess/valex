...
router.get('/balance/:id', getBalanceTransaction)
router.put('/block', joiValidation(schemaBlocksCard), blockCard)
router.put('/unblock', joiValidation(schemaBlocksCard), unblockCard)
// routes recharges
